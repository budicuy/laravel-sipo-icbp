                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="nama_diagnosa_emergency" name="nama_diagnosa_emergency" value="{{ old('nama_diagnosa_emergency', $diagnosaEmergency->nama_diagnosa_emergency) }}" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500" placeholder="Nama diagnosa emergency" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="4" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500" placeholder="Deskripsikan diagnosa emergency">{{ old('deskripsi', $diagnosaEmergency->deskripsi) }}</textarea>
                    </div>
