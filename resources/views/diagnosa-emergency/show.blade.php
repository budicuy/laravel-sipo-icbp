        ...
        <div class="bg-linear-to-r from-red-600 to-pink-600 px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('diagnosa-emergency.edit', $diagnosaEmergency->id_diagnosa_emergency) }}"
                        class="px-4 py-2 bg-white/20 hover:bg-white/30 text-white font-medium rounded-lg transition-all inline-flex items-center gap-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div class="text-center">
                            <p class="text-2xl font-bold text-green-600">{{
                                $diagnosaEmergency->keluhans->where('created_at', '>=', now()->subDays(30))->count() }}
                            </p>
                            <p class="text-sm text-gray-600">30 Hari Terakhir</p>
                        </div>
                        <div class="text-center">
                            <p class="text-2xl font-bold text-blue-600">{{
                                $diagnosaEmergency->keluhans->where('created_at', '>=', now()->subDays(7))->count() }}
                            </p>
            ...
            <table class="w-full">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">NIK
                        </th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">{{
                            $keluhan->created_at->format('d-m-Y H:i') }}</td>
                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">{{ $keluhan->user->nama_lengkap ??
                            '-' }}</td>
                    </tr>
                    @endforeach
                </tbody>
