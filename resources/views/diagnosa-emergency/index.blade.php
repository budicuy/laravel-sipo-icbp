        ...
        <div class="p-6 border-b border-gray-200 bg-linear-to-r from-gray-50 to-red-50">
            <div class="flex flex-wrap gap-3 items-center">
                <a href="{{ route('diagnosa-emergency.create') }}"
                    class="inline-flex items-center px-5 py-2.5 bg-linear-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-800 text-white text-sm font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-red-50 transition-colors">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap">
                            <input name="ids[]" value="{{ $diagnosa->id_diagnosa_emergency }}" type="checkbox"
                        ...
                        <td class="px-4 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm font-medium text-gray-900">{{ $diagnosa->nama_diagnosa_emergency
                                    }}</span>
                            </div>
                        </td>
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <nav class="flex items-center gap-2" role="navigation">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        @for ($i = $start; $i <= $end; $i++) @if ($i==$diagnosaEmergencies->currentPage())
                            <span
                                class="px-3 py-2 text-sm font-bold text-white bg-linear-to-r from-red-600 to-pink-700 rounded-lg shadow-md">{{
                                $i }}</span>
                            @else
                            ...
                            @if ($end < $diagnosaEmergencies->lastPage())
                                @if ($end < $diagnosaEmergencies->lastPage() - 1)
                                    ...
                                    <a href="{{ $diagnosaEmergencies->appends(request()->except('page'))->url($diagnosaEmergencies->lastPage()) }}"
                                        class="px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-red-50 hover:border-red-400 transition-all">{{
                                        $diagnosaEmergencies->lastPage() }}</a>
                                    @endif
                    </div>
