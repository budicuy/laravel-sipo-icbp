...
@section('page-title', 'Tambah Data Diagnosa')
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-3">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1 ml-1">Tambahkan diagnosis penyakit baru ke sistem</p>
            </div>
        </div>
    </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="nama_diagnosa" name="nama_diagnosa"
                                ...
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="4"
                            class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                            placeholder="Deskripsikan diagnosa">{{ old('deskripsi') }}</textarea>
                    </div>
                        ...
                        <div class="border border-gray-300 rounded-lg p-4 max-h-64 overflow-y-auto">
                            ...
                            <div class="flex items-center mb-2">
                                <input type="checkbox" id="obat_{{ $obat->id_obat }}" name="obat_ids[]"
                                    ...
                                    in_array($obat->id_obat, old('obat_ids', [])) ? 'checked' : '' }}>
