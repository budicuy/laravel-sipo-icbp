            ...
            <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-red-50">
                <div class="flex flex-wrap gap-3 items-center">
                    ...
                    <a href="{{ route('diagnosa-emergency.index') }}"
                        class="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 text-white text-sm font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <tr class="hover:bg-red-50 transition-colors">
                                ...
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span
                                            class="text-sm font-medium text-gray-900">{{ $diagnosa->nama_diagnosa }}</span>
                                    </div>
                                </td>
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    @for ($i = $start; $i <= $end; $i++)
                                        @if ($i == $diagnosas->currentPage())
                                            <span
                                                class="px-3 py-2 text-sm font-bold text-white bg-gradient-to-r from-red-600 to-red-700 rounded-lg shadow-md">{{ $i }}</span>
                                        @else
                                    ...
                                    @if ($end < $diagnosas->lastPage())
                                        ...
                                        <a href="{{ $diagnosas->appends(request()->except('page'))->url($diagnosas->lastPage()) }}"
                                            class="px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-red-50 hover:border-red-400 transition-all">{{ $diagnosas->lastPage() }}</a>
                                    @endif
                                </div>
