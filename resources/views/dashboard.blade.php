        ...
        <div class="relative overflow-hidden bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 rounded-xl shadow-xl p-6 text-white transform hover:scale-105 transition-all duration-300">
            ...
            <div class="relative">
                <div class="flex items-center gap-2 mb-2">
                    ...
                    <h3 class="text-xs font-medium text-blue-100">Total Pasien</h3>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-gradient-to-br from-gray-50 to-teal-50 border border-teal-100 rounded-lg p-5">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-xs text-gray-500 bg-white px-3 py-1 rounded-full border border-gray-200">Harian</span>
                    </div>
                ...
                <div class="bg-gradient-to-br from-gray-50 to-red-50 border border-red-100 rounded-lg p-5">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-2">
                            ...
                            <h4 class="text-sm font-semibold text-gray-700">Kunjungan Mingguan (per minggu bulan Oktober)</h4>
                        </div>
                        <span class="text-xs text-gray-500 bg-white px-3 py-1 rounded-full border border-gray-200">Mingguan</span>
                    </div>
                    <div style="height: 250px;">
...
<script>
    ...
    function filterCharts() {
        ...
        // Update chart titles
        document.querySelector('#dailyVisitChart').parentElement.previousElementSibling.querySelector('h4').textContent =
            `Kunjungan Harian (${getMonthName(month)} ${year})`;
        document.querySelector('#weeklyVisitChart').parentElement.previousElementSibling.querySelector('h4').textContent =
