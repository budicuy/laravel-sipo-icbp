                ...
                <div class="bg-linear-to-br from-gray-50 to-teal-50 border border-teal-100 rounded-lg p-5">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-2">
                            ...
                            <h4 id="dailyChartTitle" class="text-sm font-semibold text-gray-700">
                                Kunjungan
                                Harian
                            </h4>
                        </div>
...
<div class="p-6 bg-gray-50 min-h-screen">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-2 ml-1">
            Sistem
            Informasi
            Klinik
            Indofood
        ...
        <div onclick="navigateToKaryawan()"
            ...
            <div class="relative">
                <div class="flex items-center gap-2 mb-2">
                    <div class="w-2 h-2 bg-blue-200 rounded-full animate-pulse">
>>>>>>> f16217ef73fada68773bed43ab910eff6f5e5416
                    </div>
                    <h3 class="text-xs font-medium text-blue-100">
                        Total
                        Karyawan
                        Aktif
                    </h3>
                ...
                <div class="flex items-end justify-between">
                    <p class="text-5xl font-bold" id="totalKaryawan">
                        9999
                    </p>
        ...
        <div onclick="navigateToRekamMedis()"
            ...
            <div class="relative">
                <div class="flex items-center gap-2 mb-2">
                    <div class="w-2 h-2 bg-green-200 rounded-full animate-pulse">
                    </div>
                    <h3 class="text-xs font-medium text-green-100">
                        Total
                        Rekam
                        Medis
                    </h3>
                ...
                <div class="flex items-end justify-between">
                    <p class="text-5xl font-bold" id="totalRekamMedis">
                        9999
                    </p>
                    <div class="bg-white p-3 rounded-lg shadow-lg">
        ...
        <div onclick="navigateToKunjunganHariIni()"
            ...
            <div class="relative">
                <div class="flex items-center gap-2 mb-2">
                    <div class="w-2 h-2 bg-yellow-200 rounded-full animate-pulse">
                    </div>
                    <h3 class="text-xs font-medium text-yellow-100">
                        Kunjungan
                        Hari
                        Ini
                    </h3>
                ...
                <div class="flex items-end justify-between">
                    <p class="text-5xl font-bold" id="kunjunganHariIni">
                        9999
                    </p>
                    <div class="bg-white p-3 rounded-lg shadow-lg">
        ...
        <div onclick="navigateToOnProgress()"
            ...
            <div class="relative">
                <div class="flex items-center gap-2 mb-2">
                    <div class="w-2 h-2 bg-red-200 rounded-full animate-pulse">
                    </div>
                    <h3 class="text-xs font-medium text-red-100">
                        On
                        Progress
                    </h3>
                </div>
                <div class="flex items-end justify-between">
                    <p class="text-5xl font-bold" id="onProgress">
                        9999
                    </p>
                    <div class="bg-white p-3 rounded-lg shadow-lg">
            ...
            <div>
                ...
                <div class="relative">
                    <select id="monthFilter"
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none bg-white pr-10">
                        <option value="1" {{ date('n')==1 ? 'selected' : '' }}>
                            Januari
                        </option>
                        <option value="2" {{ date('n')==2 ? 'selected' : '' }}>
                            Februari
                        </option>
                        <option value="3" {{ date('n')==3 ? 'selected' : '' }}>
                            Maret
                        </option>
                        <option value="4" {{ date('n')==4 ? 'selected' : '' }}>
                            April
                        </option>
                        <option value="5" {{ date('n')==5 ? 'selected' : '' }}>
                            Mei
                        </option>
                        <option value="6" {{ date('n')==6 ? 'selected' : '' }}>
                            Juni
                        </option>
                        <option value="7" {{ date('n')==7 ? 'selected' : '' }}>
                            Juli
                        </option>
                        <option value="8" {{ date('n')==8 ? 'selected' : '' }}>
                            Agustus
                        </option>
                        <option value="9" {{ date('n')==9 ? 'selected' : '' }}>
                            September
                        </option>
                        <option value="10" {{ date('n')==10 ? 'selected' : '' }}>
                            Oktober
                        </option>
                ...
                <div class="bg-linear-to-br from-gray-50 to-red-50 border border-red-100 rounded-lg p-5">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-2">
                            ...
                            <h4 id="weeklyChartTitle" class="text-sm font-semibold text-gray-700">
                                Kunjungan
                                Mingguan
                            </h4>
                        </div>
        ...
        <div class="bg-linear-to-r from-purple-600 to-pink-600 p-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-purple-100 text-sm" id="diagnosaPeriod">
                        Bulan
                        ini
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    <div
                        ...
                        <div id="diagnosisList" class="grid grid-cols-1 md:grid-cols-2 gap-3 flex-1">
                            <!-- Loading state -->
