...
<div class="p-6 bg-gray-50 min-h-screen">
    ...
    <form action="{{ route('karyawan.store') }}" method="POST" enctype="multipart/form-data" id="formKaryawan"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" id="nik" name="nik" value="{{ old('nik') }}" maxlength="15"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select id="departemen" name="departemen"
                                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white"
                                        required>
                                        <option value="">-- Pilih Departemen --</option>
                                        @foreach ($departemens as $dept)
                                        <option value="{{ $dept->id_departemen }}" {{ old('departemen')==$dept->
                                            id_departemen ? 'selected' : '' }}>
