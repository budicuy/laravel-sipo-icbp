            ...
            <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" id="nik" name="nik" maxlength="15" min="0"
                                            pattern="[0-9]*" inputmode="numeric"
                                            value="{{ old('nik', $karyawan->nik_karyawan) }}"
                                            class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                                            placeholder="Masukkan NIK (hanya angka)" required>
                                    </div>
                                    @error('nik')
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="nama" name="nama"
                                            value="{{ old('nama', $karyawan->nama_karyawan) }}"
                                            class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select id="departemen" name="departemen"
                                            class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 appearance-none bg-white"
                                            required>
                                            <option value="">-- Pilih Departemen --</option>
                                            @foreach ($departemens as $dept)
                                                <option value="{{ $dept->id_departemen }}"
                                                    {{ (int) old('departemen', $karyawan->id_departemen) === (int) $dept->id_departemen ? 'selected' : '' }}>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select id="jenis_kelamin" name="jenis_kelamin"
                                            ...
                                            <option value="L"
                                                {{ old('jenis_kelamin', $karyawan->jenis_kelamin_short) == 'L' || $karyawan->jenis_kelamin == 'Laki - Laki' ? 'selected' : '' }}>
                                                Laki-laki</option>
                                            <option value="P"
                                                {{ old('jenis_kelamin', $karyawan->jenis_kelamin_short) == 'P' || $karyawan->jenis_kelamin == 'Perempuan' ? 'selected' : '' }}>
                                                Perempuan</option>
                                        </select>
                                        <div
                                            class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-gray-500">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <textarea id="alamat" name="alamat" rows="4"
                                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                                        placeholder="Masukkan alamat lengkap karyawan" required>{{ old('alamat', $karyawan->alamat) }}</textarea>
                                </div>
                                @error('alamat')
                                    <p class="text-xs text-red-600">{{ $message }}</p>
                                @enderror
                                ...
                                <div class="space-y-3">
                                                ...
                                                <div id="preview-container"
                                                    ...
                                                    @else
                                                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                            ...
                                                            <p class="mb-2 text-sm text-gray-500 font-semibold">Klik untuk
                                                                upload foto</p>
                                    ...
                                    <div class="bg-yellow-50 border border-yellow-100 rounded-lg p-3">
                                        <p class="text-xs text-yellow-800">
                                            <span class="font-semibold">Info:</span> Abaikan jika tidak ingin mengubah
                                            foto. Klik pada area foto untuk memilih file baru. Ukuran maksimal 30KB. Klik
                                            tombol X untuk menghapus foto.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="bpjs_id" name="bpjs_id"
                                    value="{{ old('bpjs_id', $karyawan->bpjs_id) }}" maxlength="50"
                                    class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                                    placeholder="Contoh: 0001234567890 (hanya angka)">
                            </div>
                            @error('bpjs_id')
                                <p class="text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select id="status" name="status" required
                                    class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 appearance-none bg-white">
                                    <option value="">-- Pilih Status --</option>
                                    <option value="aktif"
                                        {{ old('status', $karyawan->status) == 'aktif' ? 'selected' : '' }}>Aktif</option>
                                    <option value="nonaktif"
                                        {{ old('status', $karyawan->status) == 'nonaktif' ? 'selected' : '' }}>Non-Aktif
                                    </option>
                                </select>
                ...
                <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end items-center">
                    <div class="flex gap-3">
                        <button type="button" onclick="window.location.href='{{ route('karyawan.index') }}'"
                        ...
                        <button type="submit"
                            class="px-6 py-2.5 bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
                            <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M5 13l4 4L19 7" />
                            </svg>
            ...
            function previewImage(event) {
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        container.innerHTML = `
                <div class="relative w-full h-full">
                    <img src="${e.target.result}" class="w-full h-full object-contain rounded-lg" alt="Preview Foto Baru">
