        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" id="nik" name="nik" maxlength="15" min="0" pattern="[0-9]*"
                                        inputmode="numeric" value="{{ old('nik', $karyawan->nik_karyawan) }}"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select id="departemen" name="departemen"
                                        ...
                                        <option value="{{ $dept->id_departemen }}" {{ (int) old('departemen',
                                            $karyawan->id_departemen) === (int) $dept->id_departemen ? 'selected' : ''
                                            }}>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select id="jenis_kelamin" name="jenis_kelamin"
                                        ...
                                        <option value="L" {{ old('jenis_kelamin', $karyawan->jenis_kelamin_short) == 'L'
                                            || $karyawan->jenis_kelamin == 'Laki - Laki' ? 'selected' : '' }}>
                                            Laki-laki</option>
                                        <option value="P" {{ old('jenis_kelamin', $karyawan->jenis_kelamin_short) == 'P'
            ...
            <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end items-center">
                <div class="flex gap-3">
                    ...
                    <button type="submit"
                        class="px-6 py-2.5 bg-linear-to-r from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
                        <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
