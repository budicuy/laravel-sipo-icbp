                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" id="nik" name="nik" maxlength="15" min="0" pattern="[0-9]*" inputmode="numeric" value="{{ old('nik', $karyawan->nik_karyawan) }}" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500" placeholder="Masukkan NIK (hanya angka)" required>
                                </div>
                                @error('nik')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email', $karyawan->email) }}" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500" placeholder="contoh@email.com">
                        </div>
                        @error('email')
                            <p class="text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="bpjs_id" name="bpjs_id" value="{{ old('bpjs_id', $karyawan->bpjs_id) }}" maxlength="50" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500" placeholder="Contoh: 0001234567890 (hanya angka)">
                        </div>
                        @error('bpjs_id')
                            <p class="text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select id="status" name="status" required class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 appearance-none bg-white">
