                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="nik" name="nik" maxlength="15" value="{{ old('nik', $karyawan->nik_karyawan) }}" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500" placeholder="Masukkan NIK (1-15 karakter)" required>
                                </div>
                                @error('nik')
