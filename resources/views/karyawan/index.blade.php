...
<div class="p-6">
    ...
    <div class="mb-4 flex flex-wrap gap-2">
        <a href="{{ route('karyawan.create') }}" class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-md transition-colors">
