    ...
    <div class="bg-white rounded-lg shadow-md p-6 max-w-2xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-4">
                <a href="{{ route('user.index') }}" class="text-gray-600 hover:text-gray-800 transition-colors">
        ...
        <form action="{{ route('user.update', 1) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                <label for="password" class="block text-sm font-medium text-gray-700 mb-2">
                    Password <span class="text-gray-500 text-xs font-normal">(kosongkan jika tidak diganti)</span>
                </label>
                <div class="relative">
                    <input
                        type="password"
