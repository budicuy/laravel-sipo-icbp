    ...
    <form action="{{ route('user.store') }}" method="POST">
        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" class="absolute inset-y-0 right-0 pr-3 flex items-center"
                                ...
                                <svg id="password-icon" class="w-5 h-5 text-gray-400 hover:text-gray-600" fill="none"
            ...
            <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end gap-3">
                ...
                <button type="submit"
                    class="px-6 py-2.5 bg-linear-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
                    <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
