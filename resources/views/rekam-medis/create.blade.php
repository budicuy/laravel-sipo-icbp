                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <div id="info_foto" class="mt-1">
                                    <img id="foto_karyawan" src="" alt="Foto Karyawan" class="w-20 h-24 object-cover rounded-lg border border-gray-300 hidden" onerror="this.src='https://ui-avatars.com/api/?name=Unknown&background=6b7280&color=fff&size=80'">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="time" id="waktu_periksa" name="waktu_periksa" value="{{ old('waktu_periksa', \Carbon\Carbon::now('Asia/Makassar')->format('H:i')) }}" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                        </div>
                    </div>
