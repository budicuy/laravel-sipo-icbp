...
<div class="p-6 bg-gray-50 min-h-screen">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-3">
            ...
            <div class="ml-auto">
                <a href="{{ route('dashboard') }}" class="px-4 py-2 bg-white border-2 border-gray-300 hover:border-gray-400 text-gray-700 font-medium rounded-lg transition-all hover:shadow-md">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-auto">
                            <a href="{{ route('rekam-medis.create') }}" class="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all px-6 py-3 inline-block text-center">
                                <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-auto">
                            @if(session('valid_emergency_token'))
                                <a href="{{ route('rekam-medis-emergency.create') }}" class="w-full bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all px-6 py-3 inline-block text-center">
                                    <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    Buat Rekam Medis Emergency
                                    <span class="inline-block ml-2 px-3 font-bold py-1 bg-white text-green-600 bg-opacity-20 rounded-full text-xs">Token Aktif</span>
                                </a>
                            @else
                                <button onclick="showTokenModal()" class="w-full bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-300 px-6 py-3 inline-block text-center token-emergency-trigger btn-emergency transform">
                                    <svg class="w-5 h-5 inline mr-2 transition-transform group-hover:rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
                                    </svg>
                                    Masukkan Token Emergency
                                </button>
                                <p class="text-xs text-gray-500 mt-2 text-center animate-pulse">Token diperlukan untuk mengakses rekam medis emergency</p>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="text-gray-700 text-sm">
                                Digunakan untuk pasien yang sudah terdaftar sebagai karyawan atau anggota keluarga karyawan.
                                Data lengkap pasien sudah tersedia dalam sistem, sehingga proses pencatatan lebih cepat dan akurat.
                            </p>
                        </div>
                        <div>
                            ...
                            <p class="text-gray-700 text-sm">
                                ...
                                Memerlukan token akses khusus yang bisa didapatkan dari admin. Token bersifat sekali pakai dan akan hangus setelah di gunakan menambah data rekam medis.
                            </p>

                            @if(auth()->user()->role === 'Super Admin')
                            <div class="mt-4 flex gap-2">
                                <a href="{{ route('token-emergency.index') }}" class="px-3 py-2 bg-blue-100 hover:bg-blue-200 text-blue-700 font-medium rounded-lg transition-colors text-sm">
                                ...
                                <a href="{{ route('token-emergency.create') }}" class="px-3 py-2 bg-green-100 hover:bg-green-200 text-green-700 font-medium rounded-lg transition-colors text-sm">
                                    <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                    </svg>
                                    Generate Token
