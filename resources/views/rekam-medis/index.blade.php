                    ...
                    <tr class="hover:bg-green-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center border-r border-gray-200">
                            <x-button
                                variant="primary"
                                size="sm"
                                href="{{ route('rekam-medis.show', $rm->id_rekam) }}"
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center space-x-2">
                                <x-button
                                    variant="warning"
                                    size="sm"
                                    href="{{ route('rekam-medis.edit', $rm->id_rekam) }}"
                                    icon='<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <x-button
                                    ...
                                    type="button"
                                    class="delete-btn"
                                    :attributes="['data-id' => $rm->id_rekam, 'data-nama' => $rm->keluarga->nama_keluarga ?? '']"
                                    icon='<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
