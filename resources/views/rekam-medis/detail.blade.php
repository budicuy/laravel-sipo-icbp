...
@section('content')
<div class="p-4 lg:p-6 bg-linear-to-br from-gray-50 to-blue-50 min-h-screen print-area">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6">
            ...
            <div class="flex-1">
                <h1 class="text-3xl lg:text-4xl font-bold text-gray-900 flex items-center gap-3 mb-2">
                    <div class="bg-linear-to-br from-blue-600 to-cyan-600 p-3 rounded-xl shadow-lg">
    ...
    <div class="bg-white rounded-2xl shadow-lg modern-card mb-8 overflow-hidden">
        <div class="bg-linear-to-r from-blue-600 to-cyan-600 px-6 lg:px-8 py-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div class="bg-blue-800 px-5 py-2.5 rounded-full shadow-lg border-2 border-white">
                    <span class="text-white font-bold text-lg">RM:
                        {{ ($rekamMedis->keluarga->karyawan->nik_karyawan ?? '') . '-' .
                        ($rekamMedis->keluarga->kode_hubungan ?? '') }}</span>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg modern-card mb-8 overflow-hidden">
        <div class="bg-linear-to-r from-green-600 to-emerald-600 px-6 lg:px-8 py-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                ...
                <div class="bg-green-800 px-5 py-2.5 rounded-full shadow-lg border-2 border-white">
                    <span class="text-white font-bold text-lg">{{ $rekamMedis->tanggal_periksa->format('d M Y')
                        }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 lg:p-8">
            <!-- Visit Information -->
            <div class="bg-linear-to-r from-blue-50 to-cyan-50 rounded-xl p-6 border border-blue-100 mb-6">
                ...
                <div
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-start justify-between mb-5">
                        <div class="flex items-start gap-4 mb-4 lg:mb-0">
                            <div
                                class="bg-linear-to-br from-red-500 to-pink-600 text-white w-12 h-12 rounded-xl flex items-center justify-center font-bold text-lg shadow-lg">
                                {{ $keluhanIndex + 1 }}
                            </div>
                            <div>
                    ...
                    <div
                        class="mb-5 p-5 bg-linear-to-r from-blue-50 to-indigo-50 rounded-xl border-l-4 border-blue-500 shadow-sm">
                    ...
                    <div
                        class="prescription-card border-2 border-green-300 rounded-xl p-5 shadow-sm bg-linear-to-br from-green-50 to-emerald-50">
                        <div class="flex items-center gap-3 mb-5 pb-4 border-b-2 border-green-200">
                            <div class="bg-linear-to-br from-green-600 to-emerald-600 p-3 rounded-xl shadow-lg">
