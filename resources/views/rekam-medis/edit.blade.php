            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            <input type="hidden" id="id_karyawan" name="id_karyawan" value="{{ old('id_karyawan', $rekamMedis->keluarga->id_karyawan) }}" required>
                    ...
                    <div class="md:col-span-2 bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <p id="info_nama" class="font-medium text-gray-900">{{ $rekamMedis->keluarga->karyawan->nama_karyawan ?? '-' }}</p>
                            </div>
                            <div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="no_rm" name="no_rm" class="w-full pl-10 pr-4 py-2.5 bg-gray-100 border border-gray-300 rounded-lg text-gray-600" placeholder="Otomatis terisi" readonly value="{{ $rekamMedis->keluarga->no_rm ?? '' }}">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="hubungan" class="w-full pl-10 pr-4 py-2.5 bg-gray-100 border border-gray-300 rounded-lg text-gray-600" placeholder="Otomatis terisi" readonly value="{{ $rekamMedis->keluarga->hubungan->hubungan ?? '' }}">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="status" name="status" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 appearance-none bg-white" required>
                                <option value="On Progress" {{ old('status', $rekamMedis->status) == 'On Progress' ? 'selected' : '' }}>On Progress</option>
