...
<div class="p-6 bg-gray-50 min-h-screen">
    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
        ...
        <!-- Filter Section -->
        <div class="p-6 bg-linear-to-r from-purple-50 to-pink-50 border-b border-gray-200">
            ...
            <form method="GET" class="flex flex-wrap items-end gap-3">
                ...
                <div class="min-w-[180px]">
                    ...
                    <select name="kode_hubungan"
                        ...
                        <option value="{{ $hubungan->kode_hubungan }}" {{ request('kode_hubungan')==$hubungan->
                            kode_hubungan ? 'selected' : '' }}>
                            {{ $hubungan->hubungan }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="flex gap-2">
                    <button type="submit"
                        class="px-5 py-2.5 bg-linear-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white text-sm font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead>
                    <tr class="bg-linear-to-r from-purple-800 to-pink-800">
                        @if (auth()->user()->role === 'Admin' || auth()->user()->role === 'Super Admin')
                    ...
                    <tr class="hover:bg-purple-50 transition-colors">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-sm">
                            <div class="flex items-center gap-2">
                                ...
                                <form action="{{ route('keluarga.destroy', $keluarga->id_keluarga) }}" method="POST"
                                    class="delete-form">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <nav class="flex items-center gap-2" role="navigation">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        @for ($i = $start; $i <= $end; $i++) @if ($i==$keluargas->currentPage())
                            <span
                                class="px-3 py-2 text-sm font-bold text-white bg-linear-to-r from-purple-600 to-purple-700 rounded-lg shadow-md">{{
                                $i }}</span>
                            @else
