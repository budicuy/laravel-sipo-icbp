    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
        <div class="border-b border-gray-200">
            <nav class="flex -mb-px">
                <button @click="activeTab = 'enroll'" :class="activeTab === 'enroll' ? 'border-indigo-500 text-indigo-600' :
                ...
                <button @click="activeTab = 'verify'" :class="activeTab === 'verify' ? 'border-indigo-500 text-indigo-600' :
                            'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                    class="py-4 px-6 text-sm font-medium border-b-2 transition-colors duration-200 flex items-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <div class="flex items-center gap-2">
                                                <span x-text="lastCaptured.quality"
                                                    class="text-3xl font-bold px-3 py-1 rounded-full" :class="lastCaptured.quality >= 80 ?
                            ...
                            <div x-show="verifyResult?.success"
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <div class="flex-1">
                                        <!-- Nama Karyawan (Utama) -->
                                        <div
                                            class="bg-linear-to-r from-green-50 to-emerald-50 p-4 rounded-lg border border-green-200 shadow-sm mb-3">
                            ...
                            <div x-show="!verifyResult?.success"
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div
                                            class="bg-linear-to-r from-red-50 to-pink-50 p-4 rounded-lg border border-red-200 shadow-sm mb-3">
                                            <div class="flex items-center gap-3">
                                                <div
                                                    class="w-12 h-12 bg-linear-to-br from-red-500 to-pink-600 rounded-full flex items-center justify-center text-white shadow-lg">
        ...
        <div class="border-t border-gray-200">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr class="bg-linear-to-r from-indigo-600 to-purple-600">
