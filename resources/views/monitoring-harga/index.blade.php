...
<div class="p-6 bg-gray-50 min-h-screen">
    ...
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900 flex items-center gap-3">
            <div class="bg-linear-to-r from-amber-600 to-orange-600 p-3 rounded-lg shadow-lg">
        ...
        <form method="GET" action="{{ route('monitoring.harga.index') }}">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex items-end">
                    <button type="submit"
                        class="w-full px-6 py-2.5 bg-linear-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white font-medium rounded-lg transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <!-- Harga Terkini -->
        <div
            class="relative overflow-hidden bg-linear-to-br from-green-500 via-green-600 to-green-700 rounded-xl p-6 text-white">
            <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-white opacity-10 rounded-full"></div>
            <div class="relative">
                <div class="flex items-center gap-2 mb-2">
        ...
        <!-- Harga Kadaluarsa -->
        <div
            class="relative overflow-hidden bg-linear-to-br from-amber-500 via-amber-600 to-amber-700 rounded-xl p-6 text-white">
            <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-white opacity-10 rounded-full"></div>
            <div class="relative">
                <div class="flex items-center gap-2 mb-2">
    ...
    <div class="bg-white rounded-xl shadow-md p-6 mb-6 border border-gray-100">
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-2">
                <div class="bg-linear-to-r from-amber-600 to-orange-600 p-2 rounded-lg">
            ...
            <button onclick="generateRecommendations()"
                class="px-4 py-2 bg-linear-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white text-sm font-medium rounded-lg transition-all shadow-md hover:shadow-lg flex items-center gap-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
