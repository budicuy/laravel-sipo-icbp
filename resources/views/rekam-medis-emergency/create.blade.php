...
<div class="p-6 bg-gray-50 min-h-screen">
    ...
    <form action="{{ route('rekam-medis-emergency.store') }}" method="POST" id="rekam-medis-emergency-form" onsubmit="return validateForm()">
        @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="kode_rm" name="kode_rm" class="w-full pl-10 pr-4 py-2.5 bg-gray-100 border border-gray-300 rounded-lg text-gray-600" placeholder="Otomatis terisi" readonly>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" id="tanggal_periksa" name="tanggal_periksa" value="{{ old('tanggal_periksa', date('Y-m-d')) }}" class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500" required>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="status" name="status" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 appearance-none bg-white" required>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="id_diagnosa_emergency" name="id_diagnosa_emergency" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 appearance-none bg-white" required onchange="loadObatByDiagnosaEmergency(this.value)">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select id="terapi" name="terapi" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 appearance-none bg-white" required onchange="toggleObatSection()">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="keluhan" name="keluhan" rows="4" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500" placeholder="Deskripsikan keluhan pasien secara detail..." required>{{ old('keluhan') }}</textarea>
                        @error('keluhan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2" id="obat-section" style="display: none;">
                        ...
                        <div class="bg-gray-50 border border-gray-300 rounded-lg p-4">
                            <div id="obat-list-container">
                                <p class="text-sm text-gray-500 italic">Pilih diagnosa emergency terlebih dahulu untuk menampilkan obat yang sesuai.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="catatan" name="catatan" rows="3" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500" placeholder="Masukkan catatan tambahan (opsional)">{{ old('catatan') }}</textarea>
                        @error('catatan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
            <div class="bg-gray-50 px-6 py-4 flex justify-end gap-3">
                <button type="button" onclick="window.location.href='{{ route('rekam-medis-emergency.index') }}'" class="px-6 py-2.5 bg-white border-2 border-gray-300 hover:border-gray-400 text-gray-700 font-medium rounded-lg transition-all hover:shadow-md">
...
function loadObatByDiagnosaEmergency(diagnosaId) {
    ...
    if (obatData.length === 0) {
        obatListContainer.innerHTML = '<p class="text-sm text-gray-500 italic">Tidak ada obat yang tersedia untuk diagnosa ini.</p>';
    } else {
...
function selectKaryawan(employee) {
    ...
    document.getElementById('info_departemen').textContent = employee.vendor ? employee.vendor.nama_vendor : 'Tidak ada vendor';
...
function selectKaryawanFromSearch(element) {
    ...
    const employeeData = {
        ...
        vendor: { nama_vendor: element.getAttribute('data-vendor') },
        kategori: { nama_kategori: element.getAttribute('data-kategori') },
