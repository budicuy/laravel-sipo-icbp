...
<div class="p-6 bg-gray-50 min-h-screen">
    ...
    @if ($errors->any())
    <div class="mb-6 bg-linear-to-r from-red-50 to-pink-50 border-l-4 border-red-500 p-5 rounded-lg shadow-md"
        id="error-container">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="search_karyawan"
                                ...
                                placeholder="Cari karyawan external (Format: NIK-Nama Karyawan)..." autocomplete="off">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="relative">
                            <select id="id_diagnosa_emergency" name="id_diagnosa_emergency"
                                ...
                                <option value="{{ $diagnosa->id_diagnosa_emergency }}"
                                    data-obats="{{ json_encode($diagnosa->obats->map(function ($obat) {return ['id_obat' => $obat->id_obat, 'nama_obat' => $obat->nama_obat, 'stok_akhir' => $obat->stok_akhir ?? 0];})) }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="keluhan" name="keluhan" rows="4"
                            ...
                            placeholder="Deskripsikan keluhan pasien secara detail (minimal 10 karakter)..."
        ...
        `;
            ...
            <div class="border border-gray-300 rounded-lg p-3 bg-white">
                <div class="flex justify-between items-center mb-2">
                    ...
                    <span class="px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs font-medium">Stok: ${obatStok}</span>
                </div>
