    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
        <form action="{{ route('rekam-medis-emergency.update', $rekamMedisEmergency->id_emergency) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 bg-linear-to-r from-red-50 to-pink-50 border border-red-200 p-5 rounded-lg">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-gray-900">
                                {{ $rekamMedisEmergency->externalEmployee->jenis_kelamin == 'L' ? 'Laki-laki' :
                                'Perempuan' }}
                            </p>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <select name="status" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent">
                        <option value="On Progress" {{ old('status', $rekamMedisEmergency->status) == 'On Progress' ?
                            'selected' : '' }}>On
                            Progress</option>
                        <option value="Close" {{ old('status', $rekamMedisEmergency->status) == 'Close' ? 'selected' :
                            '' }}>Close
                        </option>
                    </select>
                    @error('status')
                ...
                <div class="md:col-span-2">
                    ...
                    <select name="id_diagnosa_emergency" required
                        ...
                        <option value="{{ $diagnosa->id_diagnosa_emergency }}" {{ old('id_diagnosa_emergency',
                            $rekamMedisEmergency->keluhans->first()->id_diagnosa_emergency ?? null) ==
                            $diagnosa->id_diagnosa_emergency ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="terapi" id="terapi" required
                        ...
                        <option value="Obat" {{ old('terapi', $rekamMedisEmergency->keluhans->first()->terapi ?? null)
                            == 'Obat' ? 'selected' : '' }}>
                            Obat</option>
                        <option value="Lab" {{ old('terapi', $rekamMedisEmergency->keluhans->first()->terapi ?? null) ==
                            'Lab' ? 'selected' : '' }}>
                            Konsul Faskes Lanjutan</option>
                        <option value="Istirahat" {{ old('terapi', $rekamMedisEmergency->keluhans->first()->terapi ??
                            null) == 'Istirahat' ? 'selected' : '' }}>
                            Istirahat</option>
                        <option value="Emergency" {{ old('terapi', $rekamMedisEmergency->keluhans->first()->terapi ??
                            null) == 'Emergency' ? 'selected' : '' }}>
                            Emergency</option>
                    </select>
                    @error('terapi')
                    <div class="mt-2 flex items-start">
                ...
                <div class="md:col-span-2" id="obat-section"
                    ...
                    <div class="bg-linear-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-lg p-4">
                        <div class="flex items-center gap-2 mb-3">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    ...
                                    <div>
                                        ...
                                        <select name="obat_list[{{ $index }}][aturan_pakai]"
                                            ...
                                            <option value="1 x pakai" {{ $obat['aturan_pakai']=='1 x pakai' ? 'selected'
                                                : '' }}>1
                                                x pakai
                                            </option>
                                        </select>
            ...
            <div class="flex items-center justify-end gap-3 mt-6">
                ...
                <button type="submit"
                    class="px-6 py-2.5 bg-linear-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
