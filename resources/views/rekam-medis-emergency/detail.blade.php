...
@section('content')
<div class="p-4 lg:p-6 bg-linear-to-br from-gray-50 to-red-50 min-h-screen print-area">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6">
            ...
            <div class="flex-1">
                <h1 class="text-3xl lg:text-4xl font-bold text-gray-900 flex items-center gap-3 mb-2">
                    <div class="bg-linear-to-br from-red-600 to-pink-600 p-3 rounded-xl shadow-lg">
    ...
    <div class="bg-white rounded-2xl shadow-lg modern-card mb-8 overflow-hidden">
        <div class="bg-linear-to-r from-red-600 to-pink-600 px-6 lg:px-8 py-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div class="bg-red-800 px-5 py-2.5 rounded-full shadow-lg border-2 border-white">
                    <span class="text-white font-bold text-lg">RM:
                        {{ $rekamMedisEmergency->externalEmployee->kode_rm ?? '-' }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 lg:p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                <div class="info-item p-4 rounded-xl bg-gray-50">
                    ...
                    <div class="data-value text-xl">{{ $rekamMedisEmergency->externalEmployee->nama_employee ?? '-' }}
                    </div>
                </div>
                ...
                <div class="info-item p-4 rounded-xl bg-gray-50">
                    ...
                    <div class="data-value text-xl">
                        {{ $rekamMedisEmergency->tanggal_periksa ? $rekamMedisEmergency->tanggal_periksa->format('d F
                        Y') : '-' }}
                    </div>
                </div>
                ...
                <div class="flex items-start gap-4 p-4 rounded-xl bg-red-50 border border-red-200">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="data-value text-lg">
                            {{ $rekamMedisEmergency->externalEmployee->nik_employee ?? '-' }}</div>
                        <div class="mt-2">
                            <span
    ...
    <div class="bg-white rounded-2xl shadow-lg modern-card mb-8 overflow-hidden">
        <div class="bg-linear-to-r from-orange-600 to-red-600 px-6 lg:px-8 py-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-2xl lg:text-3xl font-bold text-white drop-shadow-md">Riwayat Kunjungan
                            Emergency</h2>
                        <p class="text-orange-100 text-sm lg:text-base mt-1">Catatan pemeriksaan dan treatment pasien
                            emergency</p>
                    </div>
                </div>
        ...
        <div class="p-6 lg:p-8">
            <div class="timeline-item mb-8 last:mb-0">
                <div class="bg-linear-to-r from-red-50 to-orange-50 rounded-xl p-6 border border-red-100">
                    <div
                        class="flex flex-col lg:flex-row lg:items-center justify-between mb-6 pb-4 border-b border-red-200">
                        <div class="flex items-center gap-4 mb-4 lg:mb-0">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="data-label">Tanggal Periksa</div>
                                    <div class="data-value text-lg">
                                        {{ $rekamMedisEmergency->tanggal_periksa ?
                                        $rekamMedisEmergency->tanggal_periksa->format('d F Y') : '-' }}
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="data-value text-lg">
                                        {{ $rekamMedisEmergency->waktu_periksa ?
                                        $rekamMedisEmergency->waktu_periksa->format('H:i') : '-' }}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div>
                                    <span class="px-3 py-1
                                        ...
                                        @elseif($rekamMedisEmergency->status == 'Close') bg-green-100 text-green-800 @endif
                    ...
                    <div class="space-y-4">
                        @forelse($rekamMedisEmergency->keluhan_dikelompokkan as $keluhanIndex => $keluhanGroup)
                        <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                            <div class="flex flex-col lg:flex-row lg:items-center justify-between mb-4">
                                <div class="flex items-center gap-3 mb-3 lg:mb-0">
                                    ...
                                    <div>
                                        ...
                                        <div class="data-value text-lg font-semibold">
                                            {{ $keluhanGroup['diagnosa'] }}</div>
                                    </div>
                                </div>
                                <div class="status-badge px-3 py-1 rounded-full text-sm font-semibold
                                    {{ $keluhanGroup['terapi'] == 'Obat' ? 'bg-purple-100 text-purple-700' : '' }}
                                    {{ $keluhanGroup['terapi'] == 'Lab' ? 'bg-orange-100 text-orange-700' : '' }}
                                    {{ $keluhanGroup['terapi'] == 'Istirahat' ? 'bg-green-100 text-green-700' : '' }}">
                                    {{ $keluhanGroup['terapi'] }}
                                </div>
                            </div>
                            ...
                            <div class="mb-4 p-4 bg-blue-50 rounded-lg border-l-4 border-blue-400">
                                <div class="flex items-start gap-2">
                                    ...
                                    <div>
                                        <div class="font-semibold text-blue-700 text-sm mb-1">Catatan Dokter
                                        </div>
                                        <div class="text-gray-700">{{ $keluhanGroup['keterangan'] }}</div>
                                    </div>
                                </div>
                            </div>
                            @endif
                                    ...
                                    <div class="bg-white p-3 rounded-lg border border-green-200">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span class="text-sm text-gray-600">Aturan
                                                    Pakai:</span>
                        ...
                        <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                            ...
                            <div class="mb-4 p-4 bg-orange-50 rounded-lg border-l-4 border-orange-400">
                                <div class="flex items-start gap-2">
                                    ...
                                    <div>
                                        <div class="font-semibold text-orange-700 text-sm mb-1">Keluhan Pasien
                                        </div>
