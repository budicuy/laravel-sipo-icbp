            ...
            <div class="p-6">
                <form id="validateTokenForm" class="space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button type="submit" 
                                id="validateBtn"
                                class="px-6 py-3 bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all flex items-center gap-2">
