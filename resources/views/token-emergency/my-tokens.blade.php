...
<div class="p-6 bg-gray-50 min-h-screen">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3">
            <div class="bg-linear-to-r from-blue-600 to-indigo-600 p-3 rounded-lg shadow-lg">
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <p class="text-sm text-blue-700 mt-1">
                    Anda memiliki permintaan token yang sedang menunggu persetujuan. Mohon tunggu hingga permintaan Anda
                    diproses oleh admin.
                </p>
            </div>
        </div>
    ...
    <!-- Low Token Warning -->
    @if($availableTokensCount < 3 && !$hasPendingRequest) <div
            ...
            <div class="ml-3">
                ...
                <p class="text-sm text-yellow-700 mt-1">
                    ...
                    <button onclick="showRequestTokenModal()"
                        class="underline font-medium text-yellow-800 hover:text-yellow-900">Ajukan permintaan token
                        baru</button> untuk menghindari kehabisan token.
                </p>
            </div>
        </div>
</div>
...
<div class="bg-white rounded-xl shadow-md border border-gray-100 p-6 mb-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <button id="requestTokenBtn" onclick="showRequestTokenModal()"
            class="flex items-center justify-center px-4 py-3 bg-linear-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all {{ $hasPendingRequest ? 'opacity-50 cursor-not-allowed' : '' }}"
        ...
        <a href="{{ route('rekam-medis.chooseType') }}"
            class="flex items-center justify-center px-4 py-3 bg-linear-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
    ...
    <div class="border-b border-gray-200">
        <nav class="flex -mb-px">
            <button onclick="showTab('tokens')" id="tokens-tab"
                class="tab-button py-4 px-6 border-b-2 font-medium text-sm border-blue-500 text-blue-600 flex items-center">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
                </svg>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center text-gray-500">
                                ...
                                <p class="text-xs text-gray-500 mt-1">Mohon tunggu hingga permintaan Anda disetujui
                                    admin</p>
                                @endif
                                </p>
                            </td>
                        ...
                        <tr class="hover:bg-red-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 border-r border-gray-200">
                                <div>
                                    ...
                                    <div class="text-xs text-gray-500">{{ $rejected->approved_at->diffForHumans() }}
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-900 max-w-xs">
        ...
        <div class="mt-3 text-center">
            ...
            <div class="mt-2 px-7 py-3">
                <form id="requestTokenForm" action="{{ route('token-emergency.storeRequest') }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="notes" class="block text-sm font-medium text-gray-700 mb-2">Alasan
                            Permintaan</label>
                    ...
                    <div class="flex justify-center space-x-3">
                        ...
                        <button type="button" onclick="closeRequestTokenModal()"
