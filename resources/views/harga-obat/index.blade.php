    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
        ...
        <div class="p-6 border-b border-gray-200 bg-linear-to-r from-gray-50 to-indigo-50">
            <div class="flex flex-wrap gap-3 items-center">
                ...
                <a href="{{ route('harga-obat.create') }}"
                    class="inline-flex items-center px-5 py-2.5 bg-linear-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white text-sm font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
            ...
            <form method="GET" class="flex flex-wrap gap-4 items-end">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('harga-obat.index') }}"
                        class="px-5 py-2.5 bg-linear-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700 text-white text-sm font-medium rounded-lg shadow-md hover:shadow-lg transition-all">Reset</a>
                </div>
            </form>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead>
                    <tr class="bg-linear-to-r from-indigo-700 to-purple-700">
                        @if (auth()->user()->role === 'Admin' || auth()->user()->role === 'Super Admin')
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-indigo-50 transition-colors">
                        @if (auth()->user()->role === 'Admin' || auth()->user()->role === 'Super Admin')
                        <td class="px-4 py-3">
                            <input type="checkbox" name="selected_ids[]" value="{{ $hargaObat->id_harga_obat }}"
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <nav class="flex items-center gap-2" role="navigation">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        @for ($i = $start; $i <= $end; $i++) @if ($i==$hargaObats->currentPage())
                            <span
                                class="px-3 py-2 text-sm font-bold text-white bg-linear-to-r from-indigo-600 to-indigo-700 rounded-lg shadow-md">{{
                                $i }}</span>
                            @else
