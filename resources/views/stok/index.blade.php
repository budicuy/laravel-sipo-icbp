...
<div class="p-6 bg-gray-50 min-h-screen">
    ...
    <div class="mb-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- Total Obat Card -->
            <div class="relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
            ...
            <!-- Stok Habis Card -->
            <div class="relative overflow-hidden rounded-xl bg-gradient-to-br from-red-500 to-red-600 shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                ...
                <div class="relative p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-white text-3xl font-bold mt-1">{{ $obatsWithStok->where('sisa_stok', '<=', 0)->count() }}</p>
            ...
            <!-- Stok Rendah Card -->
            <div class="relative overflow-hidden rounded-xl bg-gradient-to-br from-yellow-500 to-orange-500 shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                ...
                <div class="relative p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-white text-3xl font-bold mt-1">{{ $obatsWithStok->where('sisa_stok', '>', 0)->where('sisa_stok', '<=', 10)->count() }}</p>
            ...
            <!-- Stok Tersedia Card -->
            <div class="relative overflow-hidden rounded-xl bg-gradient-to-br from-green-500 to-emerald-600 shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                ...
                <div class="relative p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-white text-3xl font-bold mt-1">{{ $obatsWithStok->where('sisa_stok', '>', 10)->count() }}</p>
            ...
            <form method="GET" action="{{ route('stok.index') }}" class="flex flex-wrap gap-4 items-end">
                <div class="flex-1 min-w-[300px]">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" class="pl-10 pr-4 py-2 w-full border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Masukkan nama obat...">
                    </div>
                </div>

                <div class="min-w-[200px]">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Status Stok</label>
                    <select name="stok_status" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm bg-white">
                        <option value="">Semua Status</option>
                        <option value="habis" {{ request('stok_status') == 'habis' ? 'selected' : '' }}>Stok Habis (≤ 0)</option>
                        <option value="rendah" {{ request('stok_status') == 'rendah' ? 'selected' : '' }}>Stok Rendah (1-10)</option>
                        <option value="tersedia" {{ request('stok_status') == 'tersedia' ? 'selected' : '' }}>Stok Tersedia (> 10)</option>
                    </select>
                </div>

                <div class="min-w-[200px]">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Urutkan</label>
                    <select name="sort" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm bg-white">
                        <option value="nama_obat" {{ request('sort') == 'nama_obat' ? 'selected' : '' }}>Nama Obat</option>
                        <option value="sisa_stok" {{ request('sort') == 'sisa_stok' ? 'selected' : '' }}>Sisa Stok</option>
                    </select>
                </div>

                <button type="submit" class="px-5 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white text-sm font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>
                    Filter
                </button>
                <a href="{{ route('stok.index') }}" class="px-5 py-2.5 bg-gradient-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700 text-white text-sm font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead>
                    <tr class="bg-gradient-to-r from-blue-700 to-indigo-700">
                        ...
                        <th class="px-4 py-4 text-left text-xs font-bold text-white uppercase tracking-wider w-1/6">Satuan</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-blue-50 transition-colors">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-2">
                                ...
                                <div class="min-w-0 flex-1">
                                    <a href="{{ route('stok.show', $obat->id_obat) }}" class="text-sm font-medium text-gray-900 hover:text-blue-600 truncate block" title="{{ $obat->nama_obat }}">
                                        {{ $obat->nama_obat }}
                                    </a>
                                    @if($obat->keterangan)
                                        <p class="text-xs text-gray-500 truncate" title="{{ $obat->keterangan }}">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap">
                            <span class="text-lg font-bold {{ $obat->sisa_stok <= 0 ? 'text-red-600' : ($obat->sisa_stok <= 10 ? 'text-yellow-600' : 'text-green-600') }}">
                    ...
                    <tr>
                        <td colspan="6" class="px-4 py-8 text-center text-gray-500">
                            <div class="flex flex-col items-center gap-2">
                                ...
                                <a href="{{ route('obat.create') }}" class="px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white text-sm font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
                                    Tambah Obat Baru
                                </a>
                            </div>
                        </td>
