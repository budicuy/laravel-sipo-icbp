    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
        ...
        <div class="p-6 border-b border-gray-200 bg-linear-to-r from-gray-50 to-purple-50">
            <div class="flex flex-wrap gap-3 items-center">
                ...
                <a href="{{ route('external-employee.export', request()->query()) }}"
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-purple-50 transition-colors">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                            {{ ($externalEmployees->currentPage() - 1) * $externalEmployees->perPage() +
                            $loop->iteration }}
                        </td>
                        <td class="px-4 py-4 whitespace-nowrap">
                        ...
                        <td class="px-4 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-2">
                                ...
                                <div
                                    class="w-10 h-10 bg-linear-to-br from-purple-500 to-purple-600 rounded-full items-center justify-center text-white text-xs font-bold hidden">
                                    {{ strtoupper(substr($employee->nama_employee, 0, 1)) }}
                                </div>
                                @else
                                <div
                                    class="w-10 h-10 bg-linear-to-br from-purple-500 to-purple-600 rounded-full flex items-center justify-center text-white text-xs font-bold shadow-sm">
                                    {{ strtoupper(substr($employee->nama_employee, 0, 1)) }}
                                </div>
                                @endif
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-sm">
                            <div class="flex items-center gap-2">
                                ...
                                <form action="{{ route('external-employee.destroy', $employee->id) }}" method="POST"
                                    class="delete-form">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <nav class="flex items-center gap-2" role="navigation" aria-label="Pagination Navigation">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        @for ($i = $start; $i <= $end; $i++) @if ($i==$externalEmployees->currentPage())
                            <span
