            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('external-employee.edit', $externalEmployee->id) }}" class="btn btn-warning btn-sm">
                ...
                <div class="card-body">
                            ...
                            @if($externalEmployee->foto)
                                <div class="text-center">
                                    <img src="{{ asset('storage/' . $externalEmployee->foto) }}" 
                                         alt="Foto {{ $externalEmployee->nama_employee }}" 
                        ...
                        <div class="col-md-8">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Kategori</th>
                                    <td>
                                        <span class="badge badge-{{ $externalEmployee->kategori->kode_kategori == 'x' ? 'warning' : ($externalEmployee->kategori->kode_kategori == 'y' ? 'info' : 'success') }}">
                                ...
                                <tr>
                                    <th>Status</th>
                                    <td>
                                        <span class="badge badge-{{ $externalEmployee->status == 'aktif' ? 'success' : 'danger' }}">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="btn-group">
                                <a href="{{ route('external-employee.edit', $externalEmployee->id) }}" class="btn btn-warning">
