        ...
        <form action="{{ route('external-employee.update', $externalEmployee->id_external_employee) }}" method="POST"
            ...
            <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select id="jenis_kelamin" name="jenis_kelamin"
                                            ...
                                            <option value="L"
                                                {{ old('jenis_kelamin', $externalEmployee->getRawOriginal('jenis_kelamin') ?? '') == 'L' ? 'selected' : '' }}>
                                                Laki-laki</option>
                                            <option value="P"
                                                {{ old('jenis_kelamin', $externalEmployee->getRawOriginal('jenis_kelamin') ?? '') == 'P' ? 'selected' : '' }}>
                                                Perempuan</option>
                                        </select>
                                        <div
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select id="status" name="status"
                                        ...
                                        required>
                                        <option value="aktif"
                                            {{ old('status', $externalEmployee->status) == 'aktif' ? 'selected' : '' }}>
                                            Aktif</option>
                                        <option value="nonaktif"
                                            {{ old('status', $externalEmployee->status) == 'nonaktif' ? 'selected' : '' }}>
                                            Nonaktif</option>
                                    </select>
                                    <div
                                        class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 text-gray-500">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <textarea id="alamat" name="alamat" rows="4"
                                        ...
                                        placeholder="Masukkan alamat lengkap employee" required>{{ old('alamat', $externalEmployee->alamat) }}</textarea>
                                </div>
                                @error('alamat')
                                    <p class="text-xs text-red-600">{{ $message }}</p>
                                @enderror
                ...
                <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end gap-3">
                    ...
                    <button type="submit"
                        class="px-6 py-2.5 bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
                        <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
