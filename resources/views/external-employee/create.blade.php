...
@section('page-title', 'Tambah External Employee')
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-3">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1 ml-1">Tambahkan data karyawan eksternal baru ke sistem</p>
            </div>
        </div>
    </div>
