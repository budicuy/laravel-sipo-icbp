...
<div class="p-6 bg-gray-50 min-h-screen">
    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
        ...
        <div class="p-6 border-b border-gray-200 bg-linear-to-r from-gray-50 to-green-50">
        ...
        <!-- Filter Section -->
        <div class="p-6 bg-linear-to-r from-green-50 to-emerald-50 border-b border-gray-200">
            ...
            <form method="GET" class="flex flex-wrap gap-4 items-end">
                ...
                <div class="min-w-[150px]">
                    ...
                    <select name="satuan_obat"
                        ...
                        <option value="{{ $satuan->id_satuan }}" {{ request('satuan_obat')==$satuan->id_satuan ?
                            'selected' : '' }}>
                ...
                <div class="flex gap-2">
                    <button type="submit"
                        class="px-5 py-2.5 bg-linear-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white text-sm font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead>
                    <tr class="bg-linear-to-r from-green-700 to-emerald-700">
                        @if (auth()->user()->role === 'Admin' || auth()->user()->role === 'Super Admin')
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-green-50 transition-colors">
                        ...
                        <td class="px-4 py-3 text-sm text-gray-600 max-w-xs truncate" title="{{ $obat->keterangan }}">{{
                            $obat->keterangan ?? '-' }}</td>
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <nav class="flex items-center gap-2" role="navigation">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        @for ($i = $start; $i <= $end; $i++) @if ($i==$obats->currentPage())
                            <span
                                class="px-3 py-2 text-sm font-bold text-white bg-linear-to-r from-green-600 to-green-700 rounded-lg shadow-md">{{
                                $i }}</span>
                            @else
