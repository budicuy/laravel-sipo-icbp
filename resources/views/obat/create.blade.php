                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="lokasi" name="lokasi" value="{{ old('lokasi') }}"
                                ...
                                placeholder="Contoh: Rak A-1, Lemari Es, dll">
                            @error('lokasi')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">Lokasi penyimpanan obat di gudang/apotek</p>
                        </div>

                        <!-- Keterangan (Full Width) --> <!-- Keterangan (Full Width) -->
