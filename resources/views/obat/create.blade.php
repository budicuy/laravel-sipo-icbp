                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" id="stok_awal" name="stok_awal" value="{{ old('stok_awal', 0) }}" required
                                min="0"
                            ...
                            @error('stok_awal')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">Masukkan jumlah stok awal saat pendaftaran obat pertama
                                kali</p>
                        </div>

                        <!-- Bin/Lokasi Obat -->
                        <div>
                            <label for="bin" class="block text-sm font-semibold text-gray-700 mb-2">
                                Lokasi/Bin Obat
                            </label>
                            <input type="text" id="bin" name="bin" value="{{ old('bin') }}"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 @error('bin') border-red-500 @enderror"
                                placeholder="Contoh: Rak A-1, Lemari Obat 1, dll">
                            @error('bin')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">Masukkan lokasi penyimpanan obat (rak, lemari, dll)</p>
                        </div>
