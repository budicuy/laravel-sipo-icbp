...
<div class="p-6 bg-gray-50 min-h-screen">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between w-full">
            ...
            <a href="{{ route('laporan.cetak.detail-emergency', $rekamMedisEmergency->id_emergency) }}"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
            <div class="flex items-center gap-2 mb-4">
                <div class="bg-linear-to-r from-red-600 to-pink-600 p-2 rounded-lg">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center py-2">
                    ...
                    <span class="text-sm font-medium text-gray-900">{{ $rekamMedisEmergency->externalEmployee->alamat ??
                        '-' }}</span>
                </div>
            </div>
        </div>
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center py-2 border-b border-gray-100">
                    ...
                    <span class="text-sm font-medium text-gray-900">{{
                        $rekamMedisEmergency->tanggal_periksa->format('d-m-Y') }}</span>
                </div>
                <div class="flex justify-between items-center py-2 border-b border-gray-100">
                    <span class="text-sm text-gray-600">Petugas</span>
                    <span class="text-sm font-medium text-gray-900">{{ $rekamMedisEmergency->user->nama_lengkap ?? '-'
                        }}</span>
                </div>
                <div class="flex justify-between items-center py-2">
                    <span class="text-sm text-gray-600">Status</span>
                    <span
                        class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full {{ $rekamMedisEmergency->status == 'Close' ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-yellow-100 text-yellow-800 border border-yellow-200' }}">
