            ...
            <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center py-2">
                        ...
                        <span
                            class="text-sm font-medium text-gray-900">{{ $rekamMedisEmergency->externalEmployee->alamat ?? '-' }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        ...
                        <span
                            class="text-sm font-medium text-gray-900">{{ $rekamMedisEmergency->tanggal_periksa->format('d-m-Y') }}</span>
                    </div>
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        <span class="text-sm text-gray-600">Petugas</span>
                        <span
                            class="text-sm font-medium text-gray-900">{{ $rekamMedisEmergency->user->nama_lengkap ?? '-' }}</span>
                    </div>
                    <div class="flex justify-between items-center py-2">
