...
@section('content')
    <div class="p-6 bg-gray-50 min-h-screen">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div
                class="relative overflow-hidden bg-gradient-to-br from-red-500 via-red-600 to-red-700 rounded-xl p-6 text-white">
                <!-- Decorative circles -->
                <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-white opacity-10 rounded-full"></div>
                <div class="absolute bottom-0 left-0 -mb-8 -ml-8 w-32 h-32 bg-white opacity-5 rounded-full"></div>
            ...
            <!-- Total Biaya -->
            <div
                class="relative overflow-hidden bg-gradient-to-br from-cyan-400 via-cyan-500 to-cyan-600 rounded-xl p-6 text-white">
                <!-- Decorative circles -->
                <div class="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-white opacity-10 rounded-full"></div>
                <div class="absolute bottom-0 left-0 -mb-8 -ml-8 w-32 h-32 bg-white opacity-5 rounded-full"></div>
                            ...
                            @forelse($transaksi->items() as $item)
                                <tr class="hover:bg-blue-50 transition-colors">
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <span
                                            class="text-sm font-semibold text-blue-600">{{ $item['kode_transaksi'] }}</span>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            @if ($item['tipe'] == 'Emergency')
                                                <div
                                                    class="w-8 h-8 bg-gradient-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center text-white text-xs font-bold">
                                            ...
                                            @endif
                                            <span
                                                class="text-sm font-medium text-gray-900">{{ $item['nama_pasien'] }}</span>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    @for ($i = $start; $i <= $end; $i++)
                                        @if ($i == $transaksi->currentPage())
                                            <span
                                                class="px-3 py-2 text-sm font-bold text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg shadow-md">{{ $i }}</span>
                                        @else
                                            <a href="{{ $transaksi->appends(request()->except('page'))->url($i) }}"
                                                class="px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-blue-50 hover:border-blue-400 transition-all">{{ $i }}</a>
                                        @endif
                                    @endfor
                                    ...
                                    @if ($end < $transaksi->lastPage())
                                        ...
                                        <a href="{{ $transaksi->appends(request()->except('page'))->url($transaksi->lastPage()) }}"
                                            class="px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-blue-50 hover:border-blue-400 transition-all">{{ $transaksi->lastPage() }}</a>
                                    @endif
                                </div>
