...
<div class="p-6 bg-gray-50 min-h-screen">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between w-full">
            <div class="flex items-center gap-3">
                <a href="{{ route('laporan.transaksi') }}?bulan={{ request('bulan') }}&tahun={{ request('tahun') }}&periode={{ request('periode') }}&search={{ request('search') }}&per_page={{ request('per_page') }}"
                    class="inline-flex items-center px-3 py-2 bg-white hover:bg-gray-50 text-gray-700 text-sm font-medium rounded-lg transition-all shadow-sm border border-gray-200">
            ...
            <a href="{{ route('laporan.cetak.detail', $rekamMedis->id_rekam) }}"
                class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-lg transition-all shadow-md border border-red-500"
                target="_blank">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center py-2">
                    ...
                    <span class="text-sm font-medium text-gray-900">{{
                        $rekamMedis->keluarga->tanggal_lahir->format('d-m-Y') }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
            <div class="flex items-center gap-2 mb-4">
                <div class="bg-linear-to-r from-green-600 to-emerald-600 p-2 rounded-lg">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center py-2 border-b border-gray-100">
                    ...
                    <span class="text-sm font-medium text-gray-900">{{ $rekamMedis->tanggal_periksa->format('d-m-Y')
                        }}</span>
                </div>
                <div class="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <div class="flex justify-between items-center py-2">
                    ...
                    <span
                        class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full {{ $rekamMedis->status == 'Close' ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-yellow-100 text-yellow-800 border border-yellow-200' }}">
                        {{ $rekamMedis->status }}
                    </span>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
            <div class="flex items-center gap-2 mb-4">
                <div class="bg-linear-to-r from-purple-600 to-pink-600 p-2 rounded-lg">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="space-y-3">
                <div class="flex justify-between items-center py-2 border-b border-gray-100">
                    ...
                    <span class="text-sm font-medium text-gray-900">{{ $rekamMedis->keluarga->karyawan->nik_karyawan ??
                        '-' }}</span>
                </div>
                <div class="flex justify-between items-center py-2 border-b border-gray-100">
                    <span class="text-sm text-gray-600">Nama Karyawan</span>
                    <span class="text-sm font-medium text-gray-900">{{ $rekamMedis->keluarga->karyawan->nama_karyawan ??
                        '-' }}</span>
                </div>
                <div class="flex justify-between items-center py-2">
                    <span class="text-sm text-gray-600">Departemen</span>
                    <span class="text-sm font-medium text-gray-900">{{
                        $rekamMedis->keluarga->karyawan->departemen->nama_departemen ?? '-' }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 mb-6 border border-gray-100">
        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center gap-2">
                <div class="bg-linear-to-r from-orange-600 to-red-600 p-2 rounded-lg">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <td class="px-4 py-2 text-sm font-medium text-gray-900">
                                    ...
                                    <div class="flex flex-col">
                                        <span class="line-through text-gray-400 text-xs">Rp{{
                                            number_format($subtotalSebelumDiskon, 0, ',', '.') }}</span>
                                        <span class="text-green-600">Rp{{ number_format($subtotalSetelahDiskon, 0, ',',
                                            '.') }}</span>
                                    </div>
                                    @else
    ...
    <!-- Ringkasan Biaya -->
    <div class="bg-linear-to-r from-green-50 to-emerald-50 rounded-xl shadow-md p-6 border border-green-100">
