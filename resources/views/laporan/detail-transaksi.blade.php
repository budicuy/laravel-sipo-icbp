            ...
            <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center py-2">
                        ...
                        <span
                            class="text-sm font-medium text-gray-900">{{ $rekamMedis->keluarga->tanggal_lahir->format('d-m-Y') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        ...
                        <span
                            class="text-sm font-medium text-gray-900">{{ $rekamMedis->tanggal_periksa->format('d-m-Y') }}</span>
                    </div>
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 border border-gray-100">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        ...
                        <span
                            class="text-sm font-medium text-gray-900">{{ $rekamMedis->keluarga->karyawan->nik_karyawan ?? '-' }}</span>
                    </div>
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        <span class="text-sm text-gray-600">Nama Karyawan</span>
                        <span
                            class="text-sm font-medium text-gray-900">{{ $rekamMedis->keluarga->karyawan->nama_karyawan ?? '-' }}</span>
                    </div>
                    <div class="flex justify-between items-center py-2">
                        <span class="text-sm text-gray-600">Departemen</span>
                        <span
                            class="text-sm font-medium text-gray-900">{{ $rekamMedis->keluarga->karyawan->departemen->nama_departemen ?? '-' }}</span>
                    </div>
                </div>
            </div>
        </div>
